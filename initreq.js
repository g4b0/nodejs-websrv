...
/** Aggiunta g4b0 - gestione delle variabili di sessione **/
exports.sessionGET = function(pre, idx) {
    return sessions[pre._COOKIE['NODESESSID']][idx];
};
exports.sessionSET = function(pre, idx, val) {
    sessions[pre._COOKIE['NODESESSID']][idx] = val;
    return true;
};
exports.sessionDEL = function(pre, idx) {
    delete sessions[pre._COOKIE['NODESESSID']][idx];
};
